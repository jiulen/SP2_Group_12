...
void SceneGameOver::Update(double dt)
{
	...
	if (!bLButtonState && Application::IsMousePressed(0))
	{
		...
		float BUTTON_LEFT_MAINMENU = 30;
		float BUTTON_RIGHT_MAINMENU = 50;
		float BUTTON_BOTTOM_MAINMENU = 15;
		float BUTTON_TOP_MAINMENU = 25;
...
float SceneGameOver::DistBetweenPoints(float x1, float z1, float x2, float z2)
{
	float distX = x1 - x2;
	float distZ = z1 - z2;
	float dist = 0.0f;
...
bool SceneGameOver::CollisionLineLine(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4)
{
...
bool SceneGameOver::CollisionLineRect(float x1, float y1, float x2, float y2, float rx, float ry, float rw, float rh)
{
...
bool SceneGameOver::CollisionPointCircle(float px, float py, float cx, float cy, float r)
{
...
bool SceneGameOver::CollisionLinePoint(float x1, float y1, float x2, float y2, float px, float py)
{
...
bool SceneGameOver::CollisionLineCircle(float x1, float y1, float x2, float y2, float cx, float cy, float r)
{
...
void SceneGameOver::RenderImageOnScreen(Mesh* mesh, Color color, float sizeX, float sizeY, float x, float y)
{
