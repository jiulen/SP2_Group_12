...
float SceneSettings::DistBetweenPoints(float x1, float z1, float x2, float z2)
{
	float distX = x1 - x2;
	float distZ = z1 - z2;
	float dist = 0.0f;
...
bool SceneSettings::CollisionLineLine(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4)
{
...
bool SceneSettings::CollisionLineRect(float x1, float y1, float x2, float y2, float rx, float ry, float rw, float rh)
{
...
bool SceneSettings::CollisionPointCircle(float px, float py, float cx, float cy, float r)
{
...
bool SceneSettings::CollisionLinePoint(float x1, float y1, float x2, float y2, float px, float py)
{
...
bool SceneSettings::CollisionLineCircle(float x1, float y1, float x2, float y2, float cx, float cy, float r)
{
...
void SceneSettings::RenderSkybox()
{
	/*modelStack.PushMatrix();
