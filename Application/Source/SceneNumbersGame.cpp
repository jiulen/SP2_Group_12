...
void SceneNumbersGame::Update(double dt)
{
	...
	if (!bLButtonState && Application::IsMousePressed(0))
	{
		...
		{
			if ((mouseX >= 34) && (mouseX <= 44.7) && (ticks[0] == 0))
			{
				currentno = 1;
				clicked = 1;
			}
			else if ((mouseX >= 22.3) && (mouseX <= 33) && (ticks[2] == 0))
			{
				currentno = 3;
				clicked = 1;
			}
			else if ((mouseX >= 57.4) && (mouseX <= 68.1) && (ticks[5] == 0))
			{
				currentno = 6;
				clicked = 1;
			}
			else if ((mouseX >= 10.3) && (mouseX <= 21) && (ticks[7] == 0))
			{
				currentno = 8;
				clicked = 1;
			}
		...
		{
			if ((mouseX >= 10.3) && (mouseX <= 21) && (ticks[1] == 0))
			{
				currentno = 2;
				clicked = 1;
			}
			else if ((mouseX >= 34) && (mouseX <= 44.7) && (ticks[3] == 0))
			{
				currentno = 4;
				clicked = 1;
			}
			else if ((mouseX >= 22.3) && (mouseX <= 33) && (ticks[4] == 0))
			{
				currentno = 5;
				clicked = 1;
			}
			else if ((mouseX >= 57.4) && (mouseX <= 68.1) && (ticks[6] == 0))
			{
				currentno = 7;
				clicked = 1;
			}
			else if ((mouseX >= 45.7) && (mouseX <= 56.4) && (ticks[9] == 0))
			{
				currentno = 10;
				clicked = 1;
			}
